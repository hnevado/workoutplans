<x-app-layout>
    <x-slot name="header">
     <div class="flex justify-between items-center">
        ...
        <a class="bg-orange-300 text-black rounded px-4 py-2 font-bold" href="{{route('create-athlete')}}">+ NUEVO</a>
     </div>
    </x-slot>
                                ...
                                <div class="text-gray-600 body-font">
                                    <div class="container px-5 mx-auto">
                                        ...
                                        <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                                            <h2 class="text-orange-500 text-2xl title-font font-bold mb-2 uppercase">{{$atleta->name}}</h2>
                                            <p class="leading-relaxed text-base">{{$atleta->excerpt}}</p>
                                            
                                            <div class="mt-6">
                                              <a href="{{route('edit-athlete',$atleta)}}" class="bg-orange-300 text-black rounded px-4 py-2 font-bold">Ver atleta</a> 
                                              <a href="{{route('workouts',$atleta)}}" class="bg-orange-300 text-black rounded px-4 py-2 font-bold">Ver entrenamientos</a>
                                              <form class="inline-block" method="POST" action="{{route('delete-athlete',$atleta)}}"> 
                                                ...
                                                class="bg-orange-300 text-black font-bold rounded px-4 py-2">Eliminar</button>
                                              </form>
